...
'(-p --parallel)*-d+[The revision(s) to rebase onto (can be repeated to create a merge commit)]:REVSETS:_default' \
'(-p --parallel)*--destination=[The revision(s) to rebase onto (can be repeated to create a merge commit)]:REVSETS:_default' \
